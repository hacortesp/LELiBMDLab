...
fit_df.to_csv("liclo4_rational_fit_residuals.csv", index=False)
...
plt.tight_layout()
plt.savefig("liclo4_rational_correction_factor_fit.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("liclo4_rational_fit_residuals.png", dpi=300)
plt.show()