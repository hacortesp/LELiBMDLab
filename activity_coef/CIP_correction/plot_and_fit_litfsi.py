...
INPUT_CSV = "dipole_correction_factor_litfsi.csv"
...
fit_df.to_csv("litfsi_rational_fit_residuals.csv", index=False)
...
plt.tight_layout()
plt.savefig("litfsi_rational_correction_factor_fit.png", dpi=300)
plt.show()
