...
# User settings
# ============================================================
COORD_DIR = Path("coordinates_liclo4")
OUTPUT_CSV = "liclo4_dipoles.csv"
...
def read_coordinate_file(path: Path):
    """
    Reads files with lines like:
    Li     0.772558    -0.475627     2.367339
    Cl    -0.173658     0.106102     0.132121
    O     -0.724389     0.453144     1.491555
    """
    atoms = []
    coords = []
