...
INPUT_CSV = "dipole_correction_factor_libf4.csv"
...
fit_df.to_csv("libf4_rational_fit_residuals.csv", index=False)
...
plt.tight_layout()
plt.savefig("libf4_rational_correction_factor_fit.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("libf4_rational_fit_residuals.png", dpi=300)
plt.show()