...
def configure_style():
    ...
    font_list = {"label": 16, "tick": 12, "fit": 11}
...
def fit_best_model(x: np.ndarray, y: np.ndarray):
    ...
    return best["params"], best["func"], best["name"], best["r2"], best["rmse"]
...
def plot_all(files):
    ...
    for i, file in enumerate(files):
        ...
        params, func, model_name, r2, rmse = fit_best_model(x, y)
