...
`LLE-MDLab` Li-ion Liquid Electrolyte Molecular Dynamics Lab (LLE-MDLab) is a Python-based command-line workflow designed to construct molecular models of electrolytes composed of LiPF₆ salt and one or more organic carbonate solvents parameterized with the TraPPE force field.
